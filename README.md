...
In conclusion, the use of refactored code in this particular analysis has proven to be beneficial and a worthwhile effort. Refactoring our original code was advantageous because of the practical results - the refactored code has better and more efficient execution time and performance. Those benefits provided us ways to best present and execute our analysis. It is also worth noting that we found that we were able to better understand how to manipulate and organize the information we had from our dataset; and then organize our thought process through grouping the information we wanted to extract, and were able to retrieve it into our output table more neatly and succinctly in the process of refactoring the code.
